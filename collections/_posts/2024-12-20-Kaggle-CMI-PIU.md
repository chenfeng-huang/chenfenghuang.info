...
{% include competition-project-card.html github_url="https://github.com/chenfeng-huang/Kaggle_Silver_Medal_Solutioun_CMI-PIU" repo="chenfeng-huang/Kaggle_Silver_Medal_Solutioun_CMI-PIU" display_title="Data Mining: Child Mind Institute Problematic Internet Use" description="Developed a top 3% silver-medal solution for the Kaggle CMI-PIU competition by integrating tabular and time-series features, training tree-based regressors with cross-validation, and optimizing thresholds to maximize Quadratic Weighted Kappa." %}
