...
{% include competition-project-card.html github_url="https://github.com/chenfeng-huang/Kaggle_Silver_Medal_Solutioun_CMI-DBSD" repo="chenfeng-huang/Kaggle_Silver_Medal_Solutioun_CMI-DBSD" display_title="Data Mining: Child Mind Institute Detect Behavior with Sensor Data" description="Developed a top 1% silver-medal solution for the Kaggle CMI-DBSD competition by designing a multimodal time-series model with CNN+SE, physics-inspired IMU features, and subject-level Hungarian assignment" %}
