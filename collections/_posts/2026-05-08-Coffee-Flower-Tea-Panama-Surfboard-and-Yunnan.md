---
layout: post
title: "Coffee Flower Tea: Panama Surfboard and Yunnan"
...
.coffee-flower-images .image-wrapper {
  flex: 1 1 220px;
  min-width: 200px;
  max-height: 420px;
}
.coffee-flower-images .image-wrapper img {
  display: block;
  width: 100%;
  height: 100%;
  max-height: 420px;
...
<div class="coffee-flower-images">
  <div class="image-wrapper">
    <img src="/images/2026-05-08-Coffee-Flower-Tea/Image_20260513214346_49_302.jpg" alt="Coffee flower tea preparation">
  </div>
  <div class="image-wrapper">
    <img src="/images/2026-05-08-Coffee-Flower-Tea/Image_20260513214352_50_302.jpg" alt="Coffee flower dry and brewed comparison">
  </div>
  <div class="image-wrapper">
    <img src="/images/2026-05-08-Coffee-Flower-Tea/Image_20260513214354_51_302.jpg" alt="Coffee flower tea in the cup">
  </div>
</div>

If you are curious about coffee flower, either origin is a fine place to start your mental map. If you are optimizing for **cost per interesting cup**, my takeaway from this session is simple: try Yunnan first, then treat the Panama Surfboard as a rare comparison point if the budget and the occasion align.
