...
{% include competition-project-card.html github_url="https://github.com/chenfeng-huang/Kaggle_Silver_Medal_Solution_MAP" repo="chenfeng-huang/Kaggle_Silver_Medal_Solution_MAP" display_title="Large Language Model: MAP - Charting Student Math Misunderstandings" description="Developed a top 5% silver-medal solution for the Kaggle MAP competition by training LLM models with LoRA, using family prefix filtering and cross-model consistency weighted ensemble to improve accuracy." %}
